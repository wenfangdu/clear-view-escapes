...
var RevealOnScroll = function () {
  ...
  _createClass(RevealOnScroll, [{
    key: "hideInitially",
    value: function hideInitially(els) {
      els.addClass("reveal-item");
    }
  }, {
    key: "createWaypoints",
    value: function createWaypoints(els, offset) {
      els.each(function () {
        var item = this;
        new Waypoint({
          element: item,
    ...
    value: function createPageSectionWaypoints() {
      ...
      this.pageSections.each(function () {
        ...
        new Waypoint({
          element: pageSection,
          handler: function handler(direction) {
            var matchingLink = pageSection.getAttribute("data-matching-link");
...
var Modal = function () {
  function Modal() {
    ...
    this.openBtn = (0, _jquery2.default)(".open-modal");
